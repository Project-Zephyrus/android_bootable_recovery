...
Device::BuiltinAction start_recovery(Device* device, const std::vector<std::string>& args) {
  ...
  // ZEPHYRUS_VERSION_APPEND_TIME_OF_DAY is set to true has the desired date.
  std::string ver = android::base::GetProperty("ro.zeph.version", "");
  ...
  std::vector<std::string> title_lines = {
    "Version: " + android::base::GetProperty("ro.zeph.display.version", "(unknown)") +
        "-" + ver_date,
  };
